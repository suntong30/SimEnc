...
typedef enum {
    ...
    SENDINS,
    SETENDOFBLOCK, /* 生成end of block指令 */
    SEND_HEADER, /* 输出HEADER阶段*/
...
struct inflate_state {
    ...
    code const FAR *lencode;    /* starting table for length/literal codes CCL的比特流，CL1表的开头 */
    code const FAR *distcode;   /* starting table for distance codes CL2表的开头 */
    ...
    unsigned was;               /* initial length of match */
        ...
        /* huffman重编码需要的变量 */
    unsigned char header_buf[605]; // 经过计算，huffman序列不会超过602B, 602 + 3 = 605
    ulg header_index;
    ulg header_have;
    int header_flag;
    ush my_bi_buf;

...
import (
	...
	"github.com/docker/simenc/configuration"
	ctxu "github.com/docker/simenc/context"
	"github.com/docker/simenc/health"
	"github.com/docker/simenc/health/checks"
	"github.com/docker/simenc/notifications"
	"github.com/docker/simenc/reference"
	"github.com/docker/simenc/registry/api/errcode"
	"github.com/docker/simenc/registry/api/v2"
	"github.com/docker/simenc/registry/auth"
	registrymiddleware "github.com/docker/simenc/registry/middleware/registry"
	repositorymiddleware "github.com/docker/simenc/registry/middleware/repository"
	"github.com/docker/simenc/registry/proxy"
	"github.com/docker/simenc/registry/storage"
	memorycache "github.com/docker/simenc/registry/storage/cache/memory"
	rediscache "github.com/docker/simenc/registry/storage/cache/redis"
	//	redisDedup "github.com/docker/simenc/registry/storage/cache/redisDedup"
	storagedriver "github.com/docker/simenc/registry/storage/driver"
	"github.com/docker/simenc/registry/storage/driver/factory"
	storagemiddleware "github.com/docker/simenc/registry/storage/driver/middleware"
